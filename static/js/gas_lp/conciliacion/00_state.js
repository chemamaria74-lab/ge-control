...
let FACTURAS=[], FACILITIES=[], PERFILES=[], COMPLEMENTOS=[], CLIENTES=[], SEL={}, COMP_CONFIRM_CTX=null, CRED_CLIENT_KEY='', PUB_CONFIRM_RESOLVER=null, PUB_FINAL_PAYLOAD=null, PUBLICO_COMPANY_PRICE=0;
let CANCEL_CTX=null;
