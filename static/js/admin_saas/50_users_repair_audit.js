...
function logout(){ if(window.GESessionTimeout) window.GESessionTimeout.clear(); localStorage.removeItem('zc_token'); localStorage.removeItem('sat_token'); location.href='/choice'; }
