...
def default_landing_settings() -> dict[str, Any]:
    return {
        ...
        "final_headline": "Deja de armar cada viaje entre Excel, correos y archivos sueltos.",
        "final_subtitle": "Centraliza Carta Porte, CFDI, operadores, unidades y expedientes en GE Control.",
        "form_note": "Te contactaremos para preparar una demostración del módulo de Transporte.",
        ...
        "whatsapp_message": "Hola GE Control, quiero solicitar una demo del módulo de Transporte.",
        "source": "env",
    }
