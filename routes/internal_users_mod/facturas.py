...
def _gas_lp_compact_factura_for_list(row: dict) -> dict:
    ...
    return {
        ...
        "fecha_emision": row.get("fecha_emision") or compact_md.get("fecha_emision") or "",
        "rfc_emisor": row.get("rfc_emisor") or compact_md.get("rfc_emisor") or "",
        "empresa_rfc": row.get("empresa_rfc") or compact_md.get("empresa_rfc") or "",
        "empresa_nombre": row.get("empresa_nombre") or compact_md.get("empresa_nombre") or "",
        "rfc_receptor": row.get("rfc_receptor") or "",
        "volumen_litros": row.get("volumen_litros"),
        "importe": row.get("importe"),
        "metodo_pago": row.get("metodo_pago") or compact_md.get("metodo_pago") or "",
        "forma_pago": row.get("forma_pago") or compact_md.get("forma_pago") or "",
        "saldo_insoluto": row.get("saldo_insoluto") if row.get("saldo_insoluto") not in {None, ""} else compact_md.get("saldo_insoluto"),
        "total": row.get("total") if row.get("total") not in {None, ""} else compact_md.get("total"),
        "subtotal": row.get("subtotal"),
        "iva": row.get("iva"),
        "descuento_total": row.get("descuento_total"),
        "tipo_operacion": row.get("tipo_operacion") or compact_md.get("tipo_operacion") or "",
        "is_transfer": bool(row.get("is_transfer") or compact_md.get("is_transfer")),
        "cliente_id": row.get("cliente_id") or compact_md.get("cliente_id"),
        "cliente_nombre": row.get("cliente_nombre") or compact_md.get("cliente_nombre") or compact_md.get("receptor_nombre") or "",
        "receptor_nombre": row.get("receptor_nombre") or compact_md.get("receptor_nombre") or compact_md.get("cliente_nombre") or "",
        "origen_nombre": row.get("origen_nombre") or compact_md.get("origen_nombre") or "",
        ...
        "precio_unitario_original": row.get("precio_unitario_original"),
        "litros_confirmados": row.get("litros_confirmados"),
